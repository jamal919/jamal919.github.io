...
I write small tools/softwares for work (which is fun!) and you can find those in the [software](/softwares/) page. I like to write-down my thoughts from time to time (not always publicly). There is no particular topic, but if you would like to check-out some random thoughts you can look into my [blog](/blog/). Finally, as a researcher, I felt obliged to list my [publications](/publications/) also.
